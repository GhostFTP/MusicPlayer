  ...
  return (
    <aside className="sidebar">
      ...
      <div className="sidebar-footer">
        {/* El nombre de usuario. "Cerrar sesión" se mudó a la vista Ajustes (funciona en
            SSO vía /cdn-cgi/access/logout, y en móvil — cosa que este footer, oculto
            ≤700px, no cubría). Se llega a Ajustes por el ítem del menú de arriba. */}
